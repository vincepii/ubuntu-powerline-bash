...
LINE='if [ -f ~/.local/lib/python3.6/site-packages/powerline/bindings/bash/powerline.sh ]; then source ~/.local/lib/python3.6/site-packages/powerline/bindings/bash/powerline.sh; fi'
add_line "${LINE}" ~/.bashrc

# Use the "default_leftonly" theme
CFG_FILE=~/.local/lib/python3.6/site-packages/powerline/config_files/config.json
